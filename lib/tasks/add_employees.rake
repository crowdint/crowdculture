namespace :employees do
  ...
  task :populate => :environment do
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/araoz.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/beto.png"))
    Employee.create(entry_id:"Beto", title:"role", content_url:"twitter", type:'Employee', published_date:"2009-01-01", feed_id: 99, avatar:x)

    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/chalo.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/chavez.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/edmundo.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/edwin.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/emmanuel.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/ericka.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/fernando.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/garay.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/gustavo.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/heriberto.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/herman.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/juanpablo.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/karla_gonzalez.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/karla.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/mario.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/mendo.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/tapia.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/ulices.png"))
    ...
    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/vega.png"))
    Employee.create(entry_id:"Vega", title:"role", content_url:"twitter", type:'Employee', published_date:"2009-01-01", feed_id: 99, avatar:x)

    x = URI.parse(URI.encode("http://crowdculture.herokuapp.com/ok/victor.png"))
